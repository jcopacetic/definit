...
ADMINS = [("""Jonathan Sumner""", "jonathan-sumner@example.com")]
...
# Your stuff...
# ------------------------------------------------------------------------------
MSGRAPH_CLIENT_ID = env("MSGRAPH_CLIENT_ID", default="")
MSGRAPH_CLIENT_SECRET = env("MSGRAPH_CLIENT_SECRET", default="")
MSGRAPH_TENANT_ID = env("MSGRAPH_TENANT_ID", default="")


MSGRAPH_SCOPES = ["https://graph.microsoft.com/.default"]

HS_ACCESS_TOKEN = env("HUBSPOT_ACCESS_TOKEN", default="")

FERNET_ENCRYPTION_KEY = env("FERNET_ENCRYPTION_KEY", default=None)
